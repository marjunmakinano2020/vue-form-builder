...
const VueFormBuilderInstaller = function (Vue, properties = {}) {
    ...
    const defaultProperties = {
        ...
        validationErrorAlertText:
            "Your form got error(s), please fix it and submit again",
    };
    ...
    // show alert or not?
    formDI.validationErrorShowAlert =
        properties.validationErrorShowAlert || true;
...
const disableControls = function (controlKeys) {
    controlKeys.forEach((controlKey) => (CONTROLS[controlKey].isHidden = true));
};

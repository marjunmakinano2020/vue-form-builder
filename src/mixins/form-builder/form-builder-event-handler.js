    ...
    methods: {
        ...
        sectionPushedUp(sectionObj, type = 0) {
            if (
                ...
                (sectionObj.sortOrder === this.sortedSections.length &&
                    type === 1)
            ) {
                return;
            }
            ...
            let preSectionOrder =
                type === 0 ? postSortOrder - 1 : postSortOrder + 1;
        ...
        rowDelete(rowId, sectionId) {
            ...
            const indexInSection = HELPER.findIndex(
                this.formData.sections[sectionId].rows,
                undefined,
                rowId
            );
            ...
            this.$formEvent.$emit(
                EVENT_CONSTANTS.BUILDER.ROW.DELETED,
                rowId,
                sectionId
            );
        },
        ...
        controlDeletion(parentId, controlId) {
            ...
            if (type === "section") {
                ...
                this.formData.sections[parentId].controls.splice(
                    indexInSection,
                    1
                );
            } else {

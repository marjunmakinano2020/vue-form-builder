    ...
    <div :id="control.uniqueId">
        ...
        <div v-else>
            ...
            <div :class="styles.ROW" class="radio-checkbox">
                <div
                    :class="[styles.COLUMNS.COL6, positionClasses]"
                    v-for="listItem in control.items"
                    :key="listItem.value"
                >
                    <label>
...
export default {
    ...
    computed: {
        ...
        isSameBlock() {
            return (
                this.displayMode === RADIO_CHECKBOX_STYLE.line.val ||
        ...
        positionClasses() {
            return {
                "text-center":
                    ...
                    RADIO_CHECKBOX_POSITION.center.val,
                "text-right":
                    this.control.position === RADIO_CHECKBOX_POSITION.right.val,
                "text-left":
                    this.control.position === RADIO_CHECKBOX_POSITION.left.val,
            };
        },

    ...
    methods: {
        ...
        getValue(startDate, endDate) {
            ...
            if (this.control.singleMode) {
                ...
                if (
                    this.control.returnType ===
                    DATE_PICKER_RETURN_TYPES.format.val
                ) {
            ...
            // Parse to format before emit??
            if (
                this.control.returnType === DATE_PICKER_RETURN_TYPES.format.val
            ) {
                emitValue.startDate = dayjs(startDate).format(
                    this.control.format
                );

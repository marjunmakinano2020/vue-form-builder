<template>
    <div>
        ...
        <div
            ...
            v-show="control.returnType === listReturnTypes.format.val"
        >
        ...
        <div :class="styles.FORM.FORM_GROUP">
            <label>
                ...
                <IconTooltip
                    ...
                    text="Follow this format: YYYY-MM-DD. Empty for none."
                />
            </label>
            <input
                type="text"
                :class="styles.FORM.FORM_CONTROL"
                v-model="control.minDate"
            />
        ...
        <div :class="styles.FORM.FORM_GROUP" v-show="!control.singleMode">
            ...
            <input
                ...
                step="1"
                :class="styles.FORM.FORM_CONTROL"
                v-model.number="control.minDays"
            />
        </div>
        ...
        <div :class="styles.FORM.FORM_GROUP" v-show="!control.singleMode">
            ...
            <input
                ...
                step="1"
                :class="styles.FORM.FORM_CONTROL"
                v-model.number="control.maxDays"
            />
        </div>
        ...
        <div :class="styles.FORM.FORM_GROUP">
            ...
            <input
                ...
                step="1"
                :class="styles.FORM.FORM_CONTROL"
                v-model.number="control.numberOfMonths"
            />
        ...
        <div :class="styles.FORM.FORM_GROUP">
            ...
            <input
                ...
                step="1"
                :class="styles.FORM.FORM_CONTROL"
                v-model.number="control.numberOfColumns"
            />

    ...
    <div class="sidebar-form-configuration">
        ...
        <div :class="styles.FORM.FORM_GROUP">
            <label>
                ...
                <input
                    type="checkbox"
                    v-model="formConfiguration.enableServerSideValidation"
                />
            </label>
        </div>
...
export default {
    ...
    methods: {
        ...
        preSaveValidation() {
            if (
                this.formConfiguration.enableServerSideValidation &&
                !this.formConfiguration.serverSideValidationEndpoint
            ) {

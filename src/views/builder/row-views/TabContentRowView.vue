<template>
    <section>
        ...
        <!-- Add Control -->
        <AddControlToRowControl v-if="permissions.canAddControl" :row="row" />
    </section>
</template>
...
export default Vue.extend({
    ...
    methods: {
        ...
        openTabSetting() {
            // @ts-ignore
            this.$formEvent.$emit(
                EVENT_CONSTANTS.BUILDER.MODAL.OPEN,
                this.row.uniqueId
            );
        },
        ...
        renderModal() {
            ...
            // @ts-ignore
            this.$formEvent.$emit(
                EVENT_CONSTANTS.BUILDER.MODAL.INJECT,
                modalRendererInstance,
                "Tab Configuration"
            );
        },
    ...
    created() {
        ...
        // @ts-ignore
        this.$formEvent.$on(
            EVENT_CONSTANTS.BUILDER.MODAL.SAVE,
            this.saveConfiguration
        );
        // @ts-ignore
        this.$formEvent.$on(
            EVENT_CONSTANTS.BUILDER.MODAL.SAVE_AND_CLOSE,
            this.saveAndClose
        );
        // @ts-ignore
        this.$formEvent.$on(
            EVENT_CONSTANTS.BUILDER.MODAL.AFTER_CLOSED,
            this.removeActive
        );
        // @ts-ignore
        this.$formEvent.$on(
            EVENT_CONSTANTS.BUILDER.MODAL.OPENED,
